  ...
  return (
    <main className="flex flex-1 flex-col justify-center px-4">
      <section className="flex grow flex-col items-center justify-center gap-8">
        <Link href="/blog/going-open-source">
          <span className="focus:ring-ring bg-fd-secondary text-fd-secondary-foreground hover:bg-fd-secondary/80 inline-flex items-center rounded-md border border-transparent px-2.5 py-0.5 text-xs font-semibold transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none">
            <span>We are now open source!</span>
            <svg
              width="15"
              className="ml-1"
              height="15"
