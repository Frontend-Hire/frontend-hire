...
At this point, your code should be a good match to the branch of the repository: [1-solution-part-1](https://github.com/yaralahruthik/refactoring-profile-page/tree/1-solution-part-1)
