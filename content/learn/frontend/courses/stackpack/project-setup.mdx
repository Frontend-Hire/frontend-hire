...
We have created a GitHub repository with the initial setup to make it easier for you. You can fork or clone the [repository](https://github.com/yaralahruthik/stackpack) and start working on the project. The branch should be `0-start`.

```sh
git clone https://github.com/yaralahruthik/stackpack.git
```
...
At this point, our code should match the code in the branch [`1-project-setup`](https://github.com/yaralahruthik/stackpack/tree/1-project-setup).
