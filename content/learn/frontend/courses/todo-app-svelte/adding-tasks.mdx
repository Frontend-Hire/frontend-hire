...
At this point, your code should be a good match to the branch of the repository: [3-adding-tasks](https://github.com/yaralahruthik/todo-app-svelte-tdd-typescript/tree/3-adding-tasks)
