...
At this point, your code should be a good match to the branch of the repository: [7-refactoring](https://github.com/yaralahruthik/todo-app-svelte-tdd-typescript/tree/7-refactoring)
