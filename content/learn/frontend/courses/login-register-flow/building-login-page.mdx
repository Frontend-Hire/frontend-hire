...
At this point, our code should match the code in the branch [`3-building-login-page`](https://github.com/yaralahruthik/login-register-flow-e2e-supabase/tree/3-building-login-page).
