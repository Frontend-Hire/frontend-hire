...
At this point, our code should match the code in the branch [`2-building-landing-page`](https://github.com/yaralahruthik/login-register-flow-e2e-supabase/tree/2-building-landing-page).
