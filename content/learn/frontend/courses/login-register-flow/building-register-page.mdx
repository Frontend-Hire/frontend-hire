...
At this point, our code should match the code in the branch [`5-building-register-page`](https://github.com/yaralahruthik/login-register-flow-e2e-supabase/tree/5-building-register-page).
