...
At this point, our code should match the code in the branch [`2-rendering-pages`](https://github.com/yaralahruthik/dynamic-pricing-page-next/tree/2-rendering-pages).
