...
The [starter project](https://github.com/yaralahruthik/dynamic-pricing-page-next) that you cloned does not come with the `Pages Router` setup. We will set that up now.
...
At this point, our code should match the code in the branch [`1-setup-pages-router`](https://github.com/yaralahruthik/dynamic-pricing-page-next/tree/1-setup-pages-router).
